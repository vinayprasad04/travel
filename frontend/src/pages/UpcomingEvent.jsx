...
import img from "../assets/img/Event-Banner.png";
        ...
        <div classNameName="recommendations">
          <div classNameName="container">
            ...
            <div className="filterWrap">
              <div className="filterWrap__title">Filters <button className="filterWrap__close closeFilter"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px"
              ...
              <div className="filterWrap__apply"><button className="btn closeFilter">Apply</button></div>
            </div>
